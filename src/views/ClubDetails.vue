                                ...
                                <div class="card-header">
                                    ...
                                    <el-col :span="5">
                                        <el-row>
                                            ...
                                            <el-button class="card-header-button" style="width:110px;" v-if="role==0" @click="dialogFormVisible1=true">申请成为管理员</el-button>
                                        </el-row>
                                        <el-row>
                                            <el-button class="card-header-button" v-if="role==1||role==2" @click=clubAdmin>后台管理</el-button>
                                        </el-row>
                                    </el-col>
                            ...
                            <el-scrollbar max-height="350px">
                                <el-card class="activitybox" v-for="item in ActivityList" :key="item.id" shadow="hover">
                                    ...
                                    <el-row>
                                        ...
                                        <el-col :span="3">
                                            <el-button class="button" color="#023764" @click="attentionActivity(item)">关注</el-button>
                                        </el-col>
                                    </el-row>
