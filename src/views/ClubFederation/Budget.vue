    ...
    <el-container class="" style="height: 100vh">
        ...
        <el-container>
            <el-aside width="15vw">
                <el-menu
                    class="el-menu"
                    default-active="/clubFederation/budget"
                    router=true
                    style="height: 100%;"
            ...
            <el-container>
                <el-main style="background-color: #F0F1F6;">
                    <el-card class="card">
                        ...
                        <el-table
                        :data="budgetList.slice((page-1) * limit, page * limit)" 
                        style="width: 100%"
                        size="large"
                        height="430"
                        ...
                        >
                            ...
                            <el-table-column prop="budgetApplyReason" label="申请理由"/>
                            <el-table-column prop="budgetApplyTime" sortable label="申请时间" />
                            <el-table-column
                                prop="budgetApplyIsPass"
                                label="状态"
                                width="100"
                                :filters="[
                                    { text: '已通过', value: 1 },
                                ...
                                <template #default="scope">
                                    <el-tag
                                    v-if="scope.row.budgetApplyIsPass == '1'"
                                    :type="success"
                                    disable-transitions
                                    >已通过</el-tag>
                                    <el-tag
                                    v-if="scope.row.budgetApplyIsPass =='0'"
                                    :type="scope.row.budgetApplyIsPass === '1' ? 'success' : 'danger'"
                                    disable-transitions
                                    >未通过</el-tag>
                                </template>
                            </el-table-column>
                            <el-table-column fixed="right" label="操作" width="120">
                                <template #default="operation">
                                    <el-button v-if="operation.row.feedback == null" :disabled="operation.row.budgetApplyIsPass =='1'" link type="primary" size="small" @click="dialogFormVisible = true"
                                    >审核</el-button>
                                    <el-button v-if="operation.row.feedback != null" :disabled="operation.row.budgetApplyIsPass =='1'" link type="primary" size="small" @click="dialogFormVisible = true"
                                    >查看</el-button>
                                    <el-button link type="primary" size="small" @click="confirmDeleteBudget">删除</el-button>
                                </template>
                            </el-table-column>
                        </el-table>
                        ...
                        <el-dialog v-model="dialogFormVisible" title="审批预算申请" align-center draggable>
                            <el-form :model="budget">
                            <el-form-item label="申请时间" label-width="70px">
                                <el-input disabled v-model="budget.budgetApplyTime" autocomplete="off" />
                            </el-form-item>
                            <el-form-item label="申请理由" label-width="70px">
                                <el-input disabled v-model="budget.budgetApplyReason" autocomplete="off" type="textarea" :rows="3"/>
                            </el-form-item>
                            <el-form-item required v-if="display" label="反馈" label-width="70px">
                                <el-input :disabled="budget.feedback != null" v-model="feedback" autocomplete="off" type="textarea" :rows="3"/>
                            </el-form-item>

                            <el-form-item required v-if="budget.feedback != null" label="反馈" label-width="70px">
                                <el-input :disabled="budget.feedback != null" v-model="budget.feedback" autocomplete="off" type="textarea" :rows="3"/>
                            </el-form-item>
                            ...
                            <span class="dialog-footer">
                                <el-button :disabled="budget.feedback != null" v-if="!display" @click="display=true;">不通过</el-button>
                                <el-button v-if="display" @click="display=false;feedback=null;">返回</el-button>
                                <el-button v-if="display" @click="noPass">确认</el-button>
                                <el-button :disabled="budget.feedback != null" v-if="!display" type="primary" @click="pass">通过</el-button>
                            </span>
                            </template>
                        </el-dialog>
                    </el-card>
...
methods: {
    ...
    getCurrentRow(value){
        if(value!=null){
            console.log(value);
            this.budget.budgetApplyId=value.budgetApplyId;
            this.budget.budgetApplyReason=value.budgetApplyReason;
            this.budget.budgetApplyTime=value.budgetApplyTime;
            this.budget.budgetApplyIsPass=value.budgetApplyIsPass;
            this.budget.feedback=value.feedback;
            console.log("hhhhhh");
    ...
    noPass(){
        ...
        this.$axios({
            method: 'post',
            url: '/api/examine/budget-apply',
            data: {
                id: this.budget.budgetApplyId,
                state: 0,
