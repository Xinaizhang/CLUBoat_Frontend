                        ...
                        <div style="margin-left:15px;margin-right:20px;">
                            <el-form :model="join">
                                <el-form-item label="审核状态" label-width="70px">
                                    <el-tag v-if="join.status == '已通过'" type="success" disable-transitions>已通过</el-tag>
                                ...
                                <el-button v-if="join.status == '待审批'" style="width:80px;" type="success" plain
                                    @click="pass">通过</el-button>
                                <el-button v-if="join.status == '待审批'" style="width:80px;" type="danger" plain
    ...
    methods: {
        ...
        noPass() {
            ...
            this.$axios({
                ...
                .then(res => {
                    this.join.feedback = this.feedback;
